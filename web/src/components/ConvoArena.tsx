...
import { Play, RotateCcw, AlertTriangle, ArrowLeft, ArrowRight, CheckCircle2 } from 'lucide-react';
import { ConvoData, VocabularyWord, ConvoUtterance } from '../types/capsule';
